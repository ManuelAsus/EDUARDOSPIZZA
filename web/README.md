# Eduardo's Pizza - Sistema de Tienda Online

## Descripción
Sistema completo de tienda online para Eduardo's Pizza, una pizzería ubicada en Emiliano Zapata, Tabasco. Incluye página principal responsiva, carrito de compras, gestión de pedidos, panel de administrador, seguimiento de entregas y más.
