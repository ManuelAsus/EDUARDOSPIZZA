...
function mostrarProductos(filtro) {
    ...
    if (productosFiltrados.length === 0) {
        grid.innerHTML = '<p style="grid-column: 1/-1; text-align: center; padding: 2rem; color: #202020;">No hay productos en esta categoría</p>';
        return;
    }
...
function mostrarCarrito() {
    ...
    if (carrito.length === 0) {
        carritoItems.innerHTML = '<p style="padding: 1rem; text-align: center; color: #202020;">Tu carrito está vacío</p>';
        ...
        navigator.geolocation.getCurrentPosition(
            (position) => {
                ...
                function procesarMapa(destLat, destLng, esGPS) {
                    ...
                    L.polyline(latlngs, { color: '#D01C38', weight: 3, opacity: 0.8 }).addTo(mapa);
