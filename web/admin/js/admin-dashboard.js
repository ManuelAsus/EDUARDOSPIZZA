// Admin Dashboard - Eduardo's Pizza
...
function actualizarDashboard() {
    ...
    if (pedidosRecientes.length === 0) {
        recientesHTML += '<p style="text-align: center; color: #202020;">Sin pedidos aún</p>';
    } else {
...
async function mostrarProductos() {
    ...
    if (productos.length === 0) {
        container.innerHTML = '<p style="text-align: center; color: #202020;">Sin productos. Agrega uno para comenzar.</p>';
        return;
    }
    ...
    pedidosFiltrados.forEach(pedido => {
        ...
        card.innerHTML = `
            ...
            <div class="pedido-info">
                ...
                <div class="pedido-detail">
                    <label>Total</label>
                    <p style="color: #D01C38; font-weight: bold;">$${pedido.total?.toFixed(2)}</p>
                </div>
            </div>
