// Admin Main JS - Panel Administrador de Eduardo's Pizza
...
async function actualizarDashboard() {
    ...
    if (pedidosRecientes.length === 0) {
        container.innerHTML = '<p style="text-align: center; color: #202020;">Sin pedidos aún</p>';
        return;
    }
    ...
    pedidosRecientes.forEach(pedido => {
        ...
        div.innerHTML = `
            ...
            <p style="font-size: 0.9rem; color: #979797;">${fecha}</p>
        `;
...
async function mostrarPedidos() {
    ...
    if (pedidos.length === 0) {
        container.innerHTML = '<p style="text-align: center; color: #202020;">Sin pedidos</p>';
        return;
    }
    ...
    pedidos.forEach(pedido => {
        ...
        div.innerHTML = `
            ...
            <div class="pedido-info">
                ...
                <div class="pedido-detail">
                    <label>Total</label>
                    <p style="color: #D01C38; font-weight: bold; font-size: 1.1rem;">$${pedido.total?.toFixed(2) || '0.00'}</p>
                </div>
            </div>
...
async function mostrarEntregas() {
    ...
    if (pedidosEnCamino.length === 0) {
        container.innerHTML = '<p style="text-align: center; color: #202020;">Sin entregas en proceso</p>';
        return;
    }
    ...
    pedidosEnCamino.forEach(pedido => {
        ...
        const mapasURL = `https://www.google.com/maps/search/${encodeURIComponent(pedido.direccion || 'Eduardo\'s Pizza')}`;
        ...
        div.innerHTML = `
            ...
            <iframe class="entrega-mapa" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3800.084343833688!2d-91.76562940000001!3d17.7406646!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85f3cbef06f1cb07%3A0x3049cb00c17e8e00!2sEduardo&#39;s%20Pizza%20-%20Emiliano%20Zapata!5e0!3m2!1ses-419!2smx!4v1781313651990!5m2!1ses-419!2smx" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        `;
        container.appendChild(div);
    });
}
...
async function mostrarComentarios() {
    ...
    if (comentarios.length === 0) {
        container.innerHTML = '<p style="text-align: center; color: #202020;">Sin comentarios</p>';
        return;
    }
